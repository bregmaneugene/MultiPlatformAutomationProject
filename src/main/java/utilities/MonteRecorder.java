...
import static org.monte.media.VideoFormatKeys.*;
    ...
    public class MonteRecorder extends ScreenRecorder
    {
        ...
        public String name;
        public MonteRecorder(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat,
     ...
     ####################################################################################*/
        ...
        /*####################################################################################
         ...
         Method Description: The method starts recording using Monte Recorder
        ...
        public static void startRecord(String methodName) throws Exception
        {
            ...
            screenRecorder = new MonteRecorder(gc, captureSize,
        ...
        /*####################################################################################
         ...
         Method Description: The method stops recording
         Method Parameters: NA
         Method Returns: Void
        ####################################################################################*/
